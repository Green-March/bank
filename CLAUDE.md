...
5. If `verdict: ok`, Senior updates `dashboard.md`, resets that Junior (`/clear` + `instructions/junior{N}.md`), resets Reviewer (`/clear` + `instructions/reviewer.md`), then reads `dashboard.md` and issues the next task
